  ...
  return (
    <SafeAreaView style={[styles.container, { backgroundColor: colors.background }]}>
      ...
      {isLoading ? (
        ...
        >
          <Text style={[styles.sectionTitle, { color: colors.text }]}>Bandhaki Items</Text>
          ...
          {loans.map((loan) => (
            ...
            >
              ...
              <View style={styles.loanTop}>
                <View style={[styles.loanNumBadge, { backgroundColor: colors.primaryLight }]}>
              ...
              <View style={styles.amountRow}>
                <View style={{ flex: 1 }}>
                  <Text style={[styles.amountLabel, { color: colors.textTertiary }]}>Interest Due</Text>
                  <Text style={[styles.amountVal, { color: '#EA580C' }]}>
                    {formatAmount(loan.calculatedInterest + (loan.outstandingInterest || 0))}
                  </Text>
                </View>
                <View style={{ flex: 1, alignItems: 'flex-end' }}>
                  <Text style={[styles.amountLabel, { color: colors.textTertiary }]}>Total Due</Text>
              ...
              {/* Bottom: Date + Rate */}
              <View style={[styles.loanBottom, { borderTopColor: colors.border }]}>
...
const styles = StyleSheet.create({
  ...
  bannerLeft: { flex: 1 },
  bannerLabelRow: { flexDirection: 'row', alignItems: 'center', gap: 6, marginBottom: 4 },
  bannerLabel: { fontSize: 11, fontWeight: '600', color: 'rgba(255,255,255,0.8)', textTransform: 'uppercase', letterSpacing: 1 },
  bannerTitle: { fontSize: 24, fontWeight: '800', color: '#fff', marginBottom: 10 },
  customerChip: {
    flexDirection: 'row',
    alignItems: 'center',
    gap: 6,
  ...
  customerChipText: { fontSize: 13, fontWeight: '500', color: 'rgba(255,255,255,0.9)' },
  statBox: {
    backgroundColor: 'rgba(255,255,255,0.2)',
    borderRadius: 16,
    padding: 14,
